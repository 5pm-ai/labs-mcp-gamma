...
| mcp_app | SELECT on ingests, ingest_runs (read-only for tool awareness); **SELECT on `connector_columns`, `scopes`, `scope_members`, `scope_columns`** (scope resolution and SQL validation) |
