...
| gamma-mcp | Cloud Run Service | MCP server (production) | us-east4 | persistent | braun | 2026-04-02 | Ingress: internal-and-cloud-load-balancing. SA: sa-mcp-server. Image: mcp-server:v12 |
...
| ingest-worker:v3 | Container image | Ingest job Docker image | Artifact Registry (gamma-docker) | persistent | braun | 2026-04-02 | Built from `Dockerfile.worker` |
