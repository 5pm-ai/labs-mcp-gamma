...
| gamma-mcp | Cloud Run Service | MCP server (production) | us-east4 | persistent | braun | 2026-03-25 | Ingress: internal-and-cloud-load-balancing. SA: sa-mcp-server. Image: mcp-server:v8 |
