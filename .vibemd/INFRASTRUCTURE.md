...
| gamma-mcp | Cloud Run Service | MCP server (production) | us-east4 | persistent | braun | 2026-04-01 | Ingress: internal-and-cloud-load-balancing. SA: sa-mcp-server. Image: mcp-server:v11 |
...
| ingest-worker:v2 | Container image | Ingest job Docker image | Artifact Registry (gamma-docker) | persistent | braun | 2026-03-25 | Built from `Dockerfile.worker` |
